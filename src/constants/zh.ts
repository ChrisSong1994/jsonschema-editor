export const zh = {
  ...
  schemaEditorShowSource: "显示 JSON 源代码",
  schemaEditorHideSource: "隐藏 JSON 源代码",
  ...
  demoSubtitle: "基于 Vue 3 + Element Plus 的可视化 JSON Schema 编辑器",
  demoBasicTitle: "基础用法",
  demoBasicDesc: "左侧可视化编辑，右侧实时 JSON 源码，支持拖拽分割条与全屏。",
  demoVisualOnlyTitle: "纯可视化模式",
  demoVisualOnlyDesc: '设置 show-json-editor="false"，仅展示可视化面板。',
  demoReadonlyTitle: "只读模式",
  demoReadonlyDesc: "设置 read-only，禁止一切编辑操作。",
  demoNoFullscreenTitle: "隐藏全屏按钮",
  demoNoFullscreenDesc: '设置 show-fullscreen="false"。',
  demoInferTitle: "从 JSON 推断 Schema",
  demoInferDesc: "粘贴 JSON 数据，一键生成对应的 JSON Schema。",
  demoValidateTitle: "JSON 数据校验",
  demoValidateDesc: "基于 Ajv，使用当前 Schema 校验 JSON 数据。",
  demoDialogMode: "弹窗模式",
  demoInlineMode: "内联模式",
  demoCollapseInline: "收起内联",
  demoOpenValidator: "打开校验弹窗",
  demoToggleSourceTitle: "源代码面板显示控制",
  demoToggleSourceDesc:
    "点击全屏按钮旁的切换按钮，可随时显示或隐藏 JSON 源代码面板。",
  demoPropSourceTitle: "通过参数控制源代码面板",
  demoPropSourceDesc:
    "设置 source-visible 可控制初始显隐，支持 v-model:source-visible 双向绑定。",
  demoShowSource: "显示源代码",
  demoHideSource: "隐藏源代码",
};
