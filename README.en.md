...
This library **does not bundle Element Plus styles**. You must import Element Plus styles yourself in the host application:

```js
// Full stylesheet
import "element-plus/dist/index.css";

// Or import styles on demand for only the components you use,
// e.g. element-plus/es/components/button/style/css
```

If you use dark mode, also import the dark theme variables:
